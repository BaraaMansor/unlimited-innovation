  ...
  return (
    <motion.article
      ...
      style={{
        ...
        borderWidth: '1px',
        boxShadow: hovered
          ? 'inset 0 0 0 2px rgba(255,126,0,0.4), 0 0 24px rgba(255,126,0,0.08)'
          : 'none',
      }}
    >
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-[#999] mt-3 max-w-xl">
            From concept to cloud — we deliver full-lifecycle technology
            solutions across six core competencies.
          </p>
        </motion.div>
