        ...
        <AnimatedCard>
          <div className="mb-14">
            ...
            <p className="text-[#999] mt-3 max-w-xl">
              We exist to bridge the gap between ambition and execution —
          ...
          <AnimatedCard delay={0.15}>
            <div className="glass-card glass-card-hover p-8 h-full transition-all duration-300">
              ...
              <p className="text-[#999] leading-relaxed">
                ...
                that drive measurable growth, operational efficiency, and
                sustainable competitive advantage. We partner with organizations
                to architect and deliver digital transformation at scale — from
          ...
          <AnimatedCard delay={0.25}>
            <div className="glass-card glass-card-hover p-8 h-full transition-all duration-300">
              ...
              <p className="text-[#999] leading-relaxed">
                ...
                enterprises seeking to harness the full potential of AI, data,
                and cloud-native architectures. We envision a world where every
                organization has access to enterprise-grade digital capabilities
