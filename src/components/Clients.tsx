      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-[#999] mt-3 max-w-xl">
            From startups to enterprises, we build lasting partnerships with
            ...
            return (
              ...
              >
                <div className="w-8 h-8 border border-[rgba(255,126,0,0.3)] flex items-center justify-center">
                  <span className="text-xs font-bold font-mono text-[#FF7E00]">
                    {client.initials}
                  </span>
                </div>
                <div>
          ...
          {testimonials.map((t, i) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-[#999] text-sm leading-relaxed flex-1 italic">
                  "{t.quote}"
                </p>
